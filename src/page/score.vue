  ...
  <div>
    ...
    <div class="share_code">
      <header class="share_header">
        <img src="../images/4-4.png" height="212" width="212" alt="" class="code_img">
      </header>
    </div>
...
<script>
  ...
  export default {
    ...
    /*  computedScore:function () {
        this.answerid.forEach(function (val,index) {
          if(val === this.rightAnswer[index]){
            this.score += 20;
          }
        })
      },*/
    computedScore(){
      this.answerid.forEach((val,index) => {
        if(val == this.rightAnswer[index]){
          this.score += 20;
        }
      })
